...
namespace swrenderer
{
	...
	void ProjectedWallTexcoords::ProjectTop(RenderViewport* viewport, sector_t* frontsector, sector_t* backsector, seg_t* lineseg, const FWallCoords& WallC, FTexture* pic)
	{
	...
	void ProjectedWallTexcoords::ProjectMid(RenderViewport* viewport, sector_t* frontsector, seg_t* lineseg, const FWallCoords& WallC, FTexture* pic)
	{
		side_t* sidedef = lineseg->sidedef;
		line_t* linedef = lineseg->linedef;
	...
	void ProjectedWallTexcoords::ProjectBottom(RenderViewport* viewport, sector_t* frontsector, sector_t* backsector, seg_t* lineseg, const FWallCoords& WallC, FTexture* pic)
	{
		side_t* sidedef = lineseg->sidedef;
		line_t* linedef = lineseg->linedef;
	...
	void ProjectedWallTexcoords::ProjectTranslucent(RenderViewport* viewport, sector_t* frontsector, sector_t* backsector, seg_t* lineseg, const FWallCoords& WallC, FTexture* pic)
	{
		line_t* linedef = lineseg->linedef;
		side_t* sidedef = lineseg->sidedef;
	...
	void ProjectedWallTexcoords::Project3DFloor(RenderViewport* viewport, F3DFloor* rover, seg_t* lineseg, const FWallCoords& WallC, FTexture* pic)
	{
		// find positioning
		side_t* scaledside;
		...
		double xscale = pic->Scale.X * scaledside->GetTextureXScale(scaledpart);
		float yscale = pic->Scale.Y * scaledside->GetTextureYScale(scaledpart);
	...
	void ProjectedWallTexcoords::Project(RenderViewport *viewport, double walxrepeat, const FWallCoords& WallC, FTexture* pic, fixed_t xoffset, double texturemid, float yscale, bool flipx)
	{
	...
	double ProjectedWallTexcoords::GetRowOffset(seg_t* lineseg, FTexture* tex, side_t::ETexpart texpart)
	{
	...
	fixed_t ProjectedWallTexcoords::GetXOffset(seg_t* lineseg, FTexture* tex, side_t::ETexpart texpart)
	{
	...
	double ProjectedWallTexcoords::GetXScale(side_t* sidedef, FTexture* tex, side_t::ETexpart texpart)
	{
		double TextureScaleU = sidedef->GetTextureXScale(texpart);
		return tex->Scale.X * TextureScaleU;
	}

	double ProjectedWallTexcoords::GetYScale(side_t* sidedef, FTexture* tex, side_t::ETexpart texpart)
	{
		double TextureScaleV = sidedef->GetTextureYScale(texpart);
		return tex->Scale.Y * TextureScaleV;
	}
