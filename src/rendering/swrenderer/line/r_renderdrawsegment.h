...
namespace swrenderer
{
	...
	private:
		...
		void Render3DFloorWall(DrawSegment *ds, int x1, int x2, F3DFloor *rover, double clipTop, double clipBottom, FTexture *rw_pic);
		...
		void GetNoWrapMidTextureZ(DrawSegment* ds, FTexture* tex, double& ceilZ, double& floorZ);
