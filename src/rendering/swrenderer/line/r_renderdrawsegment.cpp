...
namespace swrenderer
{
	...
	void RenderDrawSegment::Render3DFloorWall(DrawSegment *ds, int x1, int x2, F3DFloor *rover, double clipTop, double clipBottom, FTexture *rw_pic)
	{
	...
	void RenderDrawSegment::GetNoWrapMidTextureZ(DrawSegment* ds, FTexture* tex, double& ceilZ, double& floorZ)
	{
		...
		if (tex->bWorldPanning)
			rowoffset /= fabs(tex->Scale.Y * curline->sidedef->GetTextureYScale(side_t::mid));
