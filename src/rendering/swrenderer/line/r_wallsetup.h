...
namespace swrenderer
{
	...
	{
	public:
		void ProjectTop(RenderViewport* viewport, sector_t* frontsector, sector_t* backsector, seg_t* lineseg, const FWallCoords& WallC, FTexture* pic);
		void ProjectMid(RenderViewport* viewport, sector_t* frontsector, seg_t* lineseg, const FWallCoords& WallC, FTexture* pic);
		void ProjectBottom(RenderViewport* viewport, sector_t* frontsector, sector_t* backsector, seg_t* lineseg, const FWallCoords& WallC, FTexture* pic);
		void ProjectTranslucent(RenderViewport* viewport, sector_t* frontsector, sector_t* backsector, seg_t* lineseg, const FWallCoords& WallC, FTexture* pic);
		void Project3DFloor(RenderViewport* viewport, F3DFloor* rover, seg_t* lineseg, const FWallCoords& WallC, FTexture* pic);
	...
	private:
		void Project(RenderViewport* viewport, double walxrepeat, const FWallCoords& WallC, FTexture* pic, fixed_t xoffset, double texturemid, float yscale, bool flipx);

		static fixed_t GetXOffset(seg_t* lineseg, FTexture* tex, side_t::ETexpart texpart);
		static double GetRowOffset(seg_t* lineseg, FTexture* tex, side_t::ETexpart texpart);
		static double GetXScale(side_t* sidedef, FTexture* tex, side_t::ETexpart texpart);
		static double GetYScale(side_t* sidedef, FTexture* tex, side_t::ETexpart texpart);
