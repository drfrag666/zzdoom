...
namespace swrenderer
{
	...
	void RenderDrawSegment::RenderFakeWall(DrawSegment *ds, int x1, int x2, F3DFloor *rover, int lightlevel, FDynamicColormap *basecolormap, double clipTop, double clipBottom, FTexture *rw_pic)
	{
		int i;
		double xscale;
		double yscale;
