...
class ID24Incinerator : DoomWeapon // Incinerator
{
	...
	Fire:
		...
		FLMF A 0 BRIGHT A_PlaySound("weapons/incinerator/fire1", CHAN_WEAPON);
		Goto DoFire;
	FireAltSound:
		FLMF A 0 BRIGHT A_PlaySound("weapons/incinerator/fire2", CHAN_WEAPON);
		Goto DoFire;
	DoFire:
...
class ID24IncineratorFlame : Actor // Incinerator Flame 
{
	...
	Spawn:
		TNT1 A 1 BRIGHT;
		IFLM A 2 BRIGHT;
		IFLM B 2 BRIGHT A_PlaySound("weapons/incinerator/burn", CHAN_BODY);
		IFLM CDEFGH 2 BRIGHT;
		Stop;
	Death:
		IFLM A 0 BRIGHT A_Jump(128, "DeathSoundAlt");
		IFLM A 0 BRIGHT A_PlaySound("weapons/incinerator/hot1", CHAN_BODY);
		Goto DeathExplosion;
	DeathSoundAlt:
		IFLM A 0 BRIGHT A_PlaySound("weapons/incinerator/hot2", CHAN_BODY);
		Goto DeathExplosion;
	DeathExplosion:
		...
		IFLM L 2 BRIGHT;
		IFLM K 2 BRIGHT A_PlaySound("weapons/incinerator/hot3", CHAN_BODY);
