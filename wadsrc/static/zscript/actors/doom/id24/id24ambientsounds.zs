...
class ID24AmbientKlaxon : Actor
{
	...
	Spawn:
		...
		Loop;
	See:
		TNT1 A 35 A_PlaySound("ambient/klaxon");
		Loop;
	}
}
...
class ID24AmbientPortalOpen : ID24AmbientKlaxon
{
	...
	{
	See:
		TNT1 A 250 A_PlaySound("ambient/portalopen", 1);
		Stop;
	}
}
...
class ID24AmbientPortalLoop : ID24AmbientKlaxon
{
	...
	{
	See:
		TNT1 A 139 A_PlaySound("ambient/portalloop");
		Loop;
	}
}
...
class ID24AmbientPortalClose : ID24AmbientKlaxon
{
	...
	{
	See:
		TNT1 A 105 A_PlaySound("ambient/portalclose", 1);
		Stop;
	}
}
