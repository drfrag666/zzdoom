...
extend class Actor
{
	...
	deprecated("2.3") native void MBF21_JumpIfFlagsSet(State tstate, int flags, int flags2);
	deprecated("2.3") native void MBF21_AddFlags(int flags, int flags2);
	deprecated("2.3") native void MBF21_RemoveFlags(int flags, int flags2);
}
